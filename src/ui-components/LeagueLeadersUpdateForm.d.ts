...
export declare type LeagueLeadersUpdateFormInputValues = {
    passingYards?: number;
    passingTDs?: number;
    completions?: number;
...
export declare type LeagueLeadersUpdateFormValidationValues = {
...
export declare type LeagueLeadersUpdateFormOverridesProps = {
    LeagueLeadersUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type LeagueLeadersUpdateFormProps = React.PropsWithChildren<{
    overrides?: LeagueLeadersUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    leagueLeaders?: any;
    onSubmit?: (fields: LeagueLeadersUpdateFormInputValues) => LeagueLeadersUpdateFormInputValues;
    onSuccess?: (fields: LeagueLeadersUpdateFormInputValues) => void;
    onError?: (fields: LeagueLeadersUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: LeagueLeadersUpdateFormInputValues) => LeagueLeadersUpdateFormInputValues;
    onValidate?: LeagueLeadersUpdateFormValidationValues;
} & React.CSSProperties>;
export default function LeagueLeadersUpdateForm(props: LeagueLeadersUpdateFormProps): React.ReactElement;
