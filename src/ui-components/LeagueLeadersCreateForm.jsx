...
import { createLeagueLeaders } from "../graphql/mutations";
const client = generateClient();
export default function LeagueLeadersCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setPassingYards(initialValues.passingYards);
    setPassingTDs(initialValues.passingTDs);
    setCompletions(initialValues.completions);
    setPassingAttempts(initialValues.passingAttempts);
    setQbInts(initialValues.qbInts);
    setMostSacked(initialValues.mostSacked);
    setRushingYards(initialValues.rushingYards);
    setRushingTDs(initialValues.rushingTDs);
    setRushingAvg(initialValues.rushingAvg);
    setYardsAFH(initialValues.yardsAFH);
    setRushingFumbles(initialValues.rushingFumbles);
    setCatches(initialValues.catches);
    setRecYards(initialValues.recYards);
    setRecTDs(initialValues.recTDs);
    setYardsAfterCatch(initialValues.yardsAfterCatch);
    setDrops(initialValues.drops);
    setPancakes(initialValues.pancakes);
    setMostSacksAllowed(initialValues.mostSacksAllowed);
    setTackles(initialValues.tackles);
    setDefTDs(initialValues.defTDs);
    setTfls(initialValues.tfls);
    setForcedFumbles(initialValues.forcedFumbles);
    setSacks(initialValues.sacks);
    setPassDeflections(initialValues.passDeflections);
    setInts(initialValues.ints);
    setCatchAllowed(initialValues.catchAllowed);
    setErrors({});
  };
  const validations = {
    passingYards: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createLeagueLeaders.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "LeagueLeadersCreateForm")}
      {...rest}
    >
      <TextField
        label="Passing yards"
