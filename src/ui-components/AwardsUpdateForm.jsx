...
export default function AwardsUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = awardsRecord
      ...
      : initialValues;
    setOPOY(cleanValues.OPOY);
    setDPOY(cleanValues.DPOY);
    setROTY(cleanValues.ROTY);
    setGOTY(cleanValues.GOTY);
    setAmericanBowlMVP(cleanValues.americanBowlMVP);
    setCBPOTY(cleanValues.CBPOTY);
    setSGAward(cleanValues.SGAward);
    setErrors({});
  };
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          ROTY: ROTY ?? null,
          GOTY: GOTY ?? null,
          americanBowlMVP: americanBowlMVP ?? null,
          CBPOTY: CBPOTY ?? null,
          SGAward: SGAward ?? null,
        };
