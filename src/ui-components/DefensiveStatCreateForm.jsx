...
import { createDefensiveStat } from "../graphql/mutations";
const client = generateClient();
export default function DefensiveStatCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setTfl(initialValues.tfl);
    setSacks(initialValues.sacks);
    setFf(initialValues.ff);
    setTd(initialValues.td);
    setInt(initialValues.int);
    setPass_deflection(initialValues.pass_deflection);
    setCatch_allowed(initialValues.catch_allowed);
    setDeflection_rate(initialValues.deflection_rate);
    setErrors({});
  };
  const validations = {
    tackles: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createDefensiveStat.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "DefensiveStatCreateForm")}
      {...rest}
    >
      <TextField
        label="Tackles"
